...
var DepthCompress = function(compFac) {
    ...
    this.applyCompress = function(_camera, _scene) {
        if (_compressScale !== 1) {
            ...
            var m12 = 0;
            var m13 = 0;
            var m14 = -renderer._holoScreen.position.x;//-_tarPosition.x;
            var m21 = 0;
            var m22 = 1;
            var m23 = 0;
            var m24 = -renderer._holoScreen.position.y;//-_tarPosition.y;
            var m31 = 0;
            var m32 = 0;
            var m33 = 1;
            var m34 = -renderer._holoScreen.position.z;//-_tarPosition.z;
            var m41 = 0;
            var m42 = 0;
